...
namespace websocketpp { namespace transport { namespace asio {
    ...
    namespace basic_socket {
        ...
        protected:
            lib::error_code init_asio (io_service_ptr service, strand_ptr, bool)
            {
                ...
                m_socket = lib::make_shared<lib::asio::local::stream_protocol::socket>(service->get_executor());
    ...
    public:
        ...
        void init_asio(io_service_ptr ptr, lib::error_code & ec) {
            ...
            m_io_service = ptr;
            m_acceptor = lib::make_shared<lib::asio::local::stream_protocol::acceptor>(m_io_service->get_executor());
        ...
        void listen(lib::asio::local::stream_protocol::endpoint const & ep, lib::error_code & ec)
        {
            ...
            
            {
                ...
                //looks like a service is already running on that socket, don't touch it
            ...
            if (!bec) {
                m_acceptor->listen(boost::asio::socket_base::max_connections,bec);  // todo on boost upgrade: max_listen_connections
            }
            if (bec) {
                ...
                ec = std::make_error_code(static_cast<std::errc>(bec.value())); //todo
            } else {
                m_state = LISTENING;
                ec = lib::error_code();
            }
        ...
        void start_perpetual() {
            m_work = lib::make_shared<lib::asio::io_service::work>(lib::ref(*m_io_service));
        }
        ...
        timer_ptr set_timer(long duration, timer_handler callback) {
            timer_ptr new_timer = lib::make_shared<lib::asio::steady_timer>(*m_io_service, lib::asio::milliseconds(duration));
            
            new_timer->async_wait(lib::bind( &type::handle_timer, this, new_timer, callback, lib::placeholders::_1 ));
        ...
        void handle_timer(timer_ptr, timer_handler callback, lib::asio::error_code const & ec)
        {
            if (ec) {
                if (ec == lib::asio::error::operation_aborted) {
                    ...
                    callback(std::make_error_code(static_cast<std::errc>(ec.value())));
                    //; //todo
                }
            } else {
                callback(lib::error_code());
        ...
        void async_accept(transport_con_ptr tcon, accept_handler callback, lib::error_code & ec)
        {
            ...
            if (config::enable_multithreading) {
                m_acceptor->async_accept(
                                         tcon->get_raw_socket(),
                                         tcon->get_strand()->wrap(lib::bind(&type::handle_accept, this, callback, lib::placeholders::_1))
                                         );
            }
            else {
                m_acceptor->async_accept(
    ...
    protected:
        ...
        void handle_accept(accept_handler callback, lib::asio::error_code const & asio_ec)
        {
            ...
            if (asio_ec) {
                if (asio_ec == lib::asio::errc::operation_canceled) {
                    ...
                    ret_ec = std::make_error_code(static_cast<std::errc>(asio_ec.value())); //asio_ec; //todo
                }
            }
        ...
        void handle_connect(transport_con_ptr tcon, timer_ptr con_timer, connect_handler callback, lib::asio::error_code const & ec)
        {
            ...
            if (m_alog->static_test(log::alevel::devel)) {
                m_alog->write(log::alevel::devel, "Async connect to "+tcon->get_remote_endpoint()+" successful.");
            }
