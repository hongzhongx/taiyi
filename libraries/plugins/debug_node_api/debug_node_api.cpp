#include <plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <plugins/debug_node_api/debug_node_api.hpp>
...
namespace taiyi { namespace plugins { namespace debug_node {
    ...
    namespace detail {
        ...
        DEFINE_API_IMPL( debug_node_api_impl, debug_get_siming_schedule )
        {
            return _db.get( chain::siming_schedule_id_type() );
        }
        ...
        {
            if( args.hardfork_id > TAIYI_NUM_HARDFORKS )
                return {};
    ...
    {
        JSON_RPC_REGISTER_API( TAIYI_DEBUG_NODE_API_PLUGIN_NAME );
    }
