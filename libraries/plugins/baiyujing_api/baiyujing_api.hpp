...
namespace taiyi { namespace plugins { namespace baiyujing_api {
    ...
    {
        api_nfa_object(const database_api::api_nfa_object& o) : id(o.id), creator_account(o.creator_account), owner_account(o.owner_account), active_account(o.active_account), symbol(o.symbol), parent(o.parent), children(o.children), main_contract(o.main_contract), contract_data(o.contract_data), qi(legacy_asset::from_asset(o.qi)), debt_value(o.debt_value), debt_contract(o.debt_contract), cultivation_value(o.cultivation_value), created_time(o.created_time), next_tick_block(o.next_tick_block), gold(legacy_asset::from_asset(o.gold)), food(legacy_asset::from_asset(o.food)), wood(legacy_asset::from_asset(o.wood)), fabric(legacy_asset::from_asset(o.fabric)), herb(legacy_asset::from_asset(o.herb)), material_gold(legacy_asset::from_asset(o.material_gold)), material_food(legacy_asset::from_asset(o.material_food)), material_wood(legacy_asset::from_asset(o.material_wood)), material_fabric(legacy_asset::from_asset(o.material_fabric)), material_herb(legacy_asset::from_asset(o.material_herb)), five_phase(o.five_phase)
        {}
...
FC_REFLECT(taiyi::plugins::baiyujing_api::api_nfa_object, (id)(creator_account)(owner_account)(active_account)(symbol)(parent)(children)(main_contract)(contract_data)(qi)(debt_value)(debt_contract)(cultivation_value)(created_time)(next_tick_block)(gold)(food)(wood)(fabric)(herb)(material_gold)(material_food)(material_wood)(material_fabric)(material_herb)(five_phase))
