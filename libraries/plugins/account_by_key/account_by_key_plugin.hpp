...
#define TAIYI_ACCOUNT_BY_KEY_PLUGIN_NAME "account_by_key"
    ...
    public:
        ...
        static const std::string& name() { static std::string name = TAIYI_ACCOUNT_BY_KEY_PLUGIN_NAME; return name; }
