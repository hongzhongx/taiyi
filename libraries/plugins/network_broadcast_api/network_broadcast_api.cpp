...
namespace taiyi { namespace plugins { namespace network_broadcast_api {
    ...
    namespace detail
    {
        ...
        {
        public:
            network_broadcast_api_impl() : _p2p( appbase::app().get_plugin< taiyi::plugins::p2p::p2p_plugin >() ), _chain( appbase::app().get_plugin< taiyi::plugins::chain::chain_plugin >() )
            {}
            ...
            taiyi::plugins::p2p::p2p_plugin&                      _p2p;
    ...
    {
        JSON_RPC_REGISTER_API( TAIYI_NETWORK_BROADCAST_API_PLUGIN_NAME );
    }
