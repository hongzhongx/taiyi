...
namespace taiyi { namespace xuanpin {
    ...
    public:
        ...
        //contracts
        baiyujing_api::legacy_signed_transaction create_contract(const account_name_type& owner, const string& name, const string& data, bool broadcast);
        baiyujing_api::legacy_signed_transaction create_contract_from_file(const account_name_type& owner, const string& name, const string& filename, bool broadcast);
