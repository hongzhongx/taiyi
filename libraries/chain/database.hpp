...
namespace taiyi { namespace chain {
    ...
    public:
        ...
        size_t create_nfa_symbol_object(const account_object& creator, const string& symbol, const string& describe, const string& default_contract, const uint64_t& max_count);
