...
namespace taiyi { namespace chain {
    ...
    template< typename CustomOperationType >
    class generic_custom_operation_interpreter : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
    {
    public:
        ...
        virtual std::shared_ptr< taiyi::schema::abstract_schema > get_operation_schema() override
        {
            return taiyi::schema::get_schema_for_type< CustomOperationType >();
        }
