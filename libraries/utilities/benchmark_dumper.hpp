...
namespace taiyi { namespace utilities {
    ...
    public:
        ...
        {
            index_memory_details_t(std::string&& name, size_t size, size_t i_sizeof, size_t item_add_allocation, size_t add_container_allocation) :
        ...
        const measurement& dump(bool finalMeasure, get_indexes_memory_details_t get_indexes_memory_details)
        {
            if(finalMeasure)
            {
                ...
                std::sort(idxData.begin(), idxData.end(), [](const index_memory_details_t& info1, const index_memory_details_t& info2) -> bool {
...
FC_REFLECT( taiyi::utilities::benchmark_dumper::index_memory_details_t, (index_name)(index_size)(item_sizeof)(item_additional_allocation)(additional_container_allocation)(total_index_mem_usage) )

FC_REFLECT( taiyi::utilities::benchmark_dumper::database_object_sizeof_t, (object_name)(object_size) )

FC_REFLECT( taiyi::utilities::benchmark_dumper::measurement, (block_number)(real_ms)(cpu_ms)(current_mem)(peak_mem)(index_memory_details_cntr) )

FC_REFLECT( taiyi::utilities::benchmark_dumper::TAllData, (database_object_sizeofs)(measurements)(total_measurement) )
