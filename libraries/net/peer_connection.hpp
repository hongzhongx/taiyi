...
namespace taiyi { namespace net
{
    ...
    class peer_connection : public message_oriented_connection_delegate, public std::enable_shared_from_this<peer_connection>
    {
    public:
    ...
    public:
        ...
        fc::optional<std::string> taiyi_git_revision_sha;
        fc::optional<fc::time_point_sec> taiyi_git_revision_unix_timestamp;
        ...
        fc::optional<taiyi::protocol::chain_id_type> chain_id;
...
FC_REFLECT_ENUM( taiyi::net::peer_connection::our_connection_state, (disconnected)(just_connected)(connection_accepted)(connection_rejected) )
FC_REFLECT_ENUM( taiyi::net::peer_connection::their_connection_state, (disconnected)(just_connected)(connection_accepted)(connection_rejected) )
FC_REFLECT_ENUM( taiyi::net::peer_connection::connection_negotiation_status,
    (disconnected)
    (connecting)
    (connected)
    (accepting)
...
FC_REFLECT( taiyi::net::peer_connection::timestamped_item_id, (item)(timestamp) );
