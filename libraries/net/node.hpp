...
namespace taiyi { namespace net {
    ...
    public:
        ...
        virtual taiyi::protocol::chain_id_type get_chain_id() const = 0;
         ...
         */
        virtual bool handle_block( const taiyi::net::block_message& blk_msg, bool sync_mode,
         ...
         *          safe to broadcast on.
         */
        virtual void handle_transaction( const taiyi::net::trx_message& trx_msg ) = 0;
    ...
    public:
        ...
        message_propagation_data get_transaction_propagation_data(const taiyi::protocol::transaction_id_type& transaction_id);
        message_propagation_data get_block_propagation_data(const taiyi::protocol::block_id_type& block_id);
...
FC_REFLECT( taiyi::net::message_propagation_data, (received_time)(validated_time)(originating_peer) );
FC_REFLECT( taiyi::net::peer_status, (version)(host)(info) );
