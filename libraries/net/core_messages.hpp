...
namespace taiyi { namespace net {
    ...
    const uint32_t core_protocol_version = TAIYI_NET_PROTOCOL_VERSION;
...
FC_REFLECT_ENUM( taiyi::net::core_message_type_enum,
    (trx_message_type)
    (block_message_type)
...
FC_REFLECT( taiyi::net::trx_message, (trx) )
FC_REFLECT( taiyi::net::block_message, (block)(block_id) )

FC_REFLECT( taiyi::net::item_id, (item_type)(item_hash) )
FC_REFLECT( taiyi::net::item_ids_inventory_message, (item_type)(item_hashes_available) )
FC_REFLECT( taiyi::net::blockchain_item_ids_inventory_message, (total_remaining_item_count)(item_type)(item_hashes_available) )
FC_REFLECT( taiyi::net::fetch_blockchain_item_ids_message, (item_type)(blockchain_synopsis) )
FC_REFLECT( taiyi::net::fetch_items_message, (item_type)(items_to_fetch) )
FC_REFLECT( taiyi::net::item_not_available_message, (requested_item) )
FC_REFLECT( taiyi::net::hello_message, (user_agent)(core_protocol_version)(inbound_address)(inbound_port)(outbound_port)(node_public_key)(signed_shared_secret)(user_data) )

FC_REFLECT_EMPTY( taiyi::net::connection_accepted_message )
FC_REFLECT_ENUM( taiyi::net::rejection_reason_code, (unspecified)(different_chain)(already_connected)(connected_to_self)(not_accepting_connections)(blocked)(invalid_hello_message)(client_too_old) )
FC_REFLECT( taiyi::net::connection_rejected_message, (user_agent)(core_protocol_version)(remote_endpoint)(reason_code)(reason_string))
FC_REFLECT_EMPTY( taiyi::net::address_request_message )
FC_REFLECT( taiyi::net::address_info, (remote_endpoint)(last_seen_time)(latency)(node_id)(direction)(firewalled) )
FC_REFLECT( taiyi::net::address_message, (addresses) )
FC_REFLECT( taiyi::net::closing_connection_message, (reason_for_closing)(closing_due_to_error)(error) )
FC_REFLECT_ENUM( taiyi::net::peer_connection_direction, (unknown)(inbound)(outbound) )
FC_REFLECT_ENUM( taiyi::net::firewalled_state, (unknown)(firewalled)(not_firewalled) )

FC_REFLECT( taiyi::net::current_time_request_message, (request_sent_time) )
FC_REFLECT( taiyi::net::current_time_reply_message, (request_sent_time)(request_received_time)(reply_transmitted_time) )
FC_REFLECT_ENUM( taiyi::net::firewall_check_result, (unable_to_check)(unable_to_connect)(connection_successful) )
FC_REFLECT( taiyi::net::check_firewall_message, (node_id)(endpoint_to_check) )
FC_REFLECT( taiyi::net::check_firewall_reply_message, (node_id)(endpoint_checked)(result) )
FC_REFLECT_EMPTY( taiyi::net::get_current_connections_request_message )
FC_REFLECT( taiyi::net::current_connection_data, (connection_duration)(remote_endpoint)(node_id)(clock_offset)(round_trip_delay)(connection_direction)(firewalled)(user_data) )
FC_REFLECT( taiyi::net::get_current_connections_reply_message, (upload_rate_one_minute)(download_rate_one_minute)(upload_rate_fifteen_minutes)(download_rate_fifteen_minutes)(upload_rate_one_hour)(download_rate_one_hour)(current_connections) )
...
{
    template<>
    struct hash<taiyi::net::item_id>
    {
        size_t operator()(const taiyi::net::item_id& item_to_hash) const
        {
