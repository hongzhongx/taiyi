...
namespace taiyi { namespace schema {
    ...
    namespace detail {
        ...
        template< size_t N >
        struct schema_fixed_string_impl : public abstract_schema
        {
            TAIYI_SCHEMA_TEMPLATE_CLASS_BODY( schema_fixed_string_impl )
        };
        ...
        void schema_fixed_string_impl<N>::get_str_schema( std::string& s )
        {
            ...
            mvo("name", my_name)("type", "string")("max_size", N);
    ...
    template< size_t N >
    struct schema_reflect< typename taiyi::protocol::fixed_string_impl_for_size<N> >
    {
