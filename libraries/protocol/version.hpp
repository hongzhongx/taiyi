...
namespace taiyi { namespace protocol {
    ...
    /*
     * This class represents the basic versioning scheme of the Taiyi blockchain.
...
{
    class variant;
    void to_variant( const taiyi::protocol::version& v, variant& var );
    void from_variant( const variant& var, taiyi::protocol::version& v );
    
    void to_variant( const taiyi::protocol::hardfork_version& hv, variant& var );
    void from_variant( const variant& var, taiyi::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( taiyi::protocol::version, (v_num) )
FC_REFLECT_DERIVED( taiyi::protocol::hardfork_version, (taiyi::protocol::version), )

FC_REFLECT( taiyi::protocol::hardfork_version_vote, (hf_version)(hf_time) )
