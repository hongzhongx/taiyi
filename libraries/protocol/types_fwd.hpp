...
namespace fc { 
    ...
    namespace raw {
        ...
        template<typename Stream, typename T>
        inline void unpack( Stream& s, flat_set_ex<T>& value, uint32_t depth = 0) {
        ...
        template< typename Stream, typename Storage >
        inline void unpack( Stream& s, taiyi::protocol::fixed_string_impl< Storage >& u, uint32_t depth = 0 );

        template< typename Stream >
        inline void pack( Stream& s, const taiyi::protocol::asset_symbol_type& sym );
        template< typename Stream >
        inline void unpack( Stream& s, taiyi::protocol::asset_symbol_type& sym, uint32_t depth = 0 );

        template< typename Stream >
        inline void pack( Stream& s, const taiyi::protocol::legacy_taiyi_asset_symbol_type& sym );
        template< typename Stream >
        inline void unpack( Stream& s, taiyi::protocol::legacy_taiyi_asset_symbol_type& sym, uint32_t depth = 0 );
    ...
    inline void to_variant( const taiyi::protocol::fixed_string_impl< Storage >& s, fc::variant& v );
    template< typename Storage >
    inline void from_variant( const variant& v, taiyi::protocol::fixed_string_impl< Storage >& s );

    inline void to_variant( const taiyi::protocol::asset_symbol_type& sym, fc::variant& v );
