...
namespace taiyi { namespace protocol {
    ...
    struct get_required_auth_visitor
    {
        ...
        get_required_auth_visitor(flat_set<account_name_type>& a, flat_set<account_name_type>& own, flat_set<account_name_type>& post, std::vector<authority>& oth)
...
//
// Place TAIYI_DECLARE_OPERATION_TYPE in a .hpp file to declare
// functions related to your operation type
//
#define TAIYI_DECLARE_OPERATION_TYPE( OperationType )                            \
                                                                                 \
namespace taiyi { namespace protocol {                                           \
                                                                                 \
