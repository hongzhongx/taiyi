...
namespace taiyi { namespace protocol {
    ...
    struct signed_transaction : public transaction
    {
        ...
        set<public_key_type> get_required_signatures(const chain_id_type& chain_id,
                                                     ...
                                                     uint32_t max_recursion = TAIYI_MAX_SIG_CHECK_DEPTH,
                                                     uint32_t max_membership = TAIYI_MAX_AUTHORITY_MEMBERSHIP,
                                                     uint32_t max_account_auths = TAIYI_MAX_SIG_CHECK_ACCOUNTS,
...
FC_REFLECT( taiyi::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( taiyi::protocol::signed_transaction, (taiyi::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( taiyi::protocol::annotated_signed_transaction, (taiyi::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
