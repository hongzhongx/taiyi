...
namespace taiyi { namespace schema { namespace detail {
    ...
    TAIYI_SCHEMA_DEFINE_CLASS_METHODS( schema_account_name_type_impl )
    ...
    void schema_account_name_type_impl::get_str_schema( std::string& s )
    {
        ...
        mvo("name", my_name)("type", "account_name_type");
    ...
    TAIYI_SCHEMA_DEFINE_CLASS_METHODS( schema_asset_symbol_type_impl )
    ...
    void schema_asset_symbol_type_impl::get_str_schema( std::string& s )
    {
        ...
        get_name( my_name );
        fc::mutable_variant_object mvo;
        mvo("name", my_name)("type", "asset_symbol_type");
