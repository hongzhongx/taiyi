...
#define TAIYI_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )     \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
    : public abstract_schema                                    \
{                                                               \
    TAIYI_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )             \
};

// Templated version of macro includes some method definitions
#define TAIYI_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )           \
...
#define TAIYI_SCHEMA_CLASS_BODY( CLASSNAME )                    \
...
#define TAIYI_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )          \
    ...
    TAIYI_DECLARE_SCHEMA_CLASS( false, false )
    TAIYI_DECLARE_SCHEMA_CLASS(  true, false )
    TAIYI_DECLARE_SCHEMA_CLASS(  true,  true )
