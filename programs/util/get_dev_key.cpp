...
int main( int argc, char** argv )
{
    try
    {
        ...
        if( need_help )
        {
            ...
            "Examples:\n"
            "\n"
            "  get_dev_key xyz owner-5 active-7 balance-9 wit-block-signing-3 wit-owner-5 wit-active-33\n"
            "  get_dev_key xyz wit-block-signing-0:101\n"
            "\n";
            return 1;
        }
        ...
        auto show_key = [&]( const fc::ecc::private_key& priv_key, const std::string& name )
        {
            ...
            taiyi::protocol::public_key_type pub_key = priv_key.get_public_key();
            mvo( "private_key", taiyi::utilities::key_to_wif( priv_key ) )
