...
def parse_arguments(src_default):
    ...
    parser = MyParser(description="Helper function to call cmake with appropriate configuration to build Taiyi.")
    ...
    node_type.add_argument("-w", "--siming", dest="low_mem_node", action="store_true", default=argparse.SUPPRESS, help="build with LOW_MEMORY_NODE=ON")
    ...
    parser.add_argument("--src", dest="source_dir", metavar="SOURCEDIR", type=convert_to_dir, default=argparse.SUPPRESS, 
                        help="Taiyi source directory (if omitted, will assume is at ../.. relative to location of this script)")
