...
BOOST_AUTO_TEST_CASE( positive_validation )
{
    try
    {
        ...
        request = "{\"jsonrpc\":\"2.0\", \"method\":\"call\", \"params\":[\"baiyujing_api\", \"get_dynamic_global_properties\", []], \"id\":8}";
        make_positive_request( request );
        
        request = "{\"jsonrpc\":\"2.0\", \"method\":\"baiyujing_api.get_dynamic_global_properties\", \"params\":[], \"id\":12}";
        make_positive_request( request );
        ...
        request = "{\"jsonrpc\":\"2.0\", \"method\":\"call\", \"params\":[\"baiyujing_api\", \"get_accounts\", [[\"init_miner\"]]], \"id\":6}";
        make_positive_request( request );
        
        request = "{\"jsonrpc\":\"2.0\", \"method\":\"baiyujing_api.get_accounts\", \"params\":[[\"init_miner\"]], \"id\":7}";
        make_positive_request( request );
        
        request = "{\"jsonrpc\":\"2.0\", \"method\":\"call\", \"params\":[\"baiyujing_api\", \"get_accounts\", [[]]], \"id\":8}";
        make_positive_request( request );
        
        request = "{\"jsonrpc\":\"2.0\", \"method\":\"baiyujing_api.get_accounts\", \"params\":[[]], \"id\":9}";
        make_positive_request( request );
